    ...
    try
    {
        ...
        if(response.length === 0)
        {
            ...
            return res.status(400).json(
                {
                    success:false,
                    message:"OTP Not Present in DB For this Email Address"
                })
        }
        ...
        // after otp verification, hash the password
        ...
        // create additional profile info for user
        ...
        // create user on basis of role of user in DB
...
exports.changePassword = async (req,res)=>
{
    try
    {
        ...
        //     return res.status(400).json({
		// 		success: false,
		// 		message: "The Old Password and Confirm Password does not match",
		// 	});
        // }
